...
- Ensure idempotency, implement retries, and handle timeouts for all external calls.
...
- Ensure security, enforce rate limits, and implement observability for every new endpoint.
